"""
K-Nearest Neighbors (KNN) Model for Bank Marketing Dataset
...
def main():
    ...
    """
    print("=" * 60)
    print("K-Nearest Neighbors (KNN) - Bank Marketing Dataset")
    print("=" * 60)
    ...
    print("[✓] Model saved successfully: models/knn_model.pkl")
    print("\n" + "=" * 60)
