"""
Random Forest Model for Bank Marketing Dataset
...
def main():
    ...
    """
    print("=" * 60)
    print("Random Forest - Bank Marketing Dataset")
    print("=" * 60)
    ...
    # Train model
    print("\n[4/5] Training Random Forest model (100 trees)...")
    ...
    print("[✓] Model saved successfully: models/random_forest_model.pkl")
    print("\n" + "=" * 60)
