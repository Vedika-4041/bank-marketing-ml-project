"""
Naive Bayes Model for Bank Marketing Dataset
...
def main():
    ...
    """
    print("=" * 60)
    print("Gaussian Naive Bayes - Bank Marketing Dataset")
    print("=" * 60)
    ...
    # Train model
    print("\n[4/5] Training Gaussian Naive Bayes model...")
    ...
    print("[✓] Model saved successfully: models/naive_bayes_model.pkl")
    print("\n" + "=" * 60)
